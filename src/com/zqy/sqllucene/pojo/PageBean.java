...
public class PageBean {
	  ...
	  public void setRangeIndex() {
	    ...
	    if(totalPage < 2) { startIndex = 0; endIndex = totalPage - startIndex; } else { int currentPage = getCurrentPage(); if(groupSize >= totalPage) {
	        startIndex = 0;
	        ...
	        } else if(currentPage <= leftOffset) { startIndex = 0; endIndex = groupSize - 1; } else { startIndex = currentPage - leftOffset - 1; if(currentPage + rightOffset > totalPage) {
	  ...
	  public int getCurrentPage() {
	    if(currentPage <= 0) { currentPage = 1; } else { int totalPage = getTotalPage(); if(totalPage > 0 && currentPage > getTotalPage()) {
	  ...
	  public PageBean(int currentPage, int pageSize, Collection items) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.items = items;
	  }

	  public PageBean(int currentPage, int pageSize, Collection items, int groupSize) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.items = items;
	  ...
	  public PageBean(int currentPage, int pageSize, int groupSize, int afterDocId) {
	    this.currentPage = currentPage;
	    this.pageSize = pageSize;
	    this.groupSize = groupSize;
	    this.afterDocId = afterDocId;
	  ...
	  public static void main(String[] args) {
	    ...
	    PageBean page = new PageBean(1,10,items,10);
